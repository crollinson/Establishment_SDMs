...
selLst = scan('Data/model_inputs/selvar_Current_ClimOnly.txt',what='string') # List of selected predictors; this is held constant across species
...
dat.out <- "Data/analyses/RF_Current_PA_ClimOnly/"
fig.out <- "Figures/RF_Current_PA_ClimOnly/"
