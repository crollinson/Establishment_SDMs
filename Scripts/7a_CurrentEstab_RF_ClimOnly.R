...
selLst = scan('Data/model_inputs/selvar_Estab_ClimOnly.txt',what='string') # List of selected predictors; this is held constant across species
...
dat.out <- "Data/analyses/RF_Estab_ClimOnly/"
fig.out <- "Figures/RF_Estab_ClimOnly/"
